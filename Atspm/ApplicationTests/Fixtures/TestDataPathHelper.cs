...
// for ApplicationTests - Utah.Udot.Atspm.ApplicationTests.Fixtures/TestDataPathHelper.cs
// 
...
namespace Utah.Udot.Atspm.ApplicationTests.Fixtures
{
    ...
    {
        public static string ApplicationAnalysisTestData(string fileName)
        {
            var root = FindRepoRoot();
            return Path.Combine(root, "ApplicationTests", "Analysis", "TestData", fileName);
        }
